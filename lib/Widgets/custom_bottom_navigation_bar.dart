...
class CustomBottomNavigationBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        Container(
          height: 84, // Menambahkan ketinggian container untuk menyesuaikan dengan tombol presensi di luar batas atas navbar
          ...
          child: Row(
            ...
            children: [
              InkWell(
                ...
                child: Ink(
                  padding: EdgeInsets.only(top: 17, bottom: 6, right: 45, left: 40), // Menambahkan padding
                  child: Column(
              ...
              SizedBox(width: 10), // Penambahan widget kosong untuk posisi tengah
              InkWell(
                onTap: () {
                ...
                child: Ink(
                  padding: EdgeInsets.only(top: 17, bottom: 6, right: 40, left: 45), // Menambahkan padding
                  child: Column(
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      Icon(
